...
import { poppins, poppinsItalic } from '@/helpers/fonts'
  ...
  return (
    <div className=' lg:h-[584px] px-[24px] lg:px-[100px] mt-[40px] lg:mt-[120px]'>
        <article className='bg-[#9EE463] w-full h-auto relative overflow-hidden z-10 p-6 lg:p-20'>
            ...
            <p className={`${poppins.className} text-sm lg:text-xl mx-auto mt-6 text-center w-[90%]`}>
            ...
            <article className='mt-[14px] lg:mt-[60px] mx-auto text-center'>
                <a href="/about-us" className={`bg-[#7000FF] text-white text-[18px] lg:text-2xl ${poppins.className} font-medium py-[14px] lg:py-5 px-20 block lg:inline-block`}>
                    Explore about us
                </a>
            </article>
        </article>
