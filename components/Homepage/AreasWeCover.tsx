...
export const AreasWeCover = () => {
  return (
    <div className='lg:h-[1397px] bg-[#0A0615] w-full mt-[-350px] relative overflow-hidden pt-[420px] pb-[40px] lg:pb-0'>
        ...
        />
        <h4 className={`px-6 text-[20px] leading-[28px] lg:text-5xl lg:leading-[56px] z-10 text-white lg:w-[60%] font-bold lg:mx-auto text-center relative w-full`}>
        ...
        <div className='mt-7 lg:mt-14 text-white px-6 lg:px-[100px] z-10 relative grid grid-cols-1 lg:grid-cols-3 gap-6'>
            <ProductCard url='/services/mobile-app-development' icon='/market-research.png' titleClassName='w-[50%]' title='Market Research' subtitle='Uncover hidden opportunities, understand your target audience deeply, and gain a competitive edge.' />
