  ...
  return (
    <div className='flex justify-between py-6 lg:py-10 px-6 lg:px-[100px] items-center'>
        ...
        <article className={`hidden lg:flex items-center space-x-20 ${inter.className} font-medium`}>
            ...
            <a className='uppercase font-medium' href="/about-us"> About us </a>
            <a className='uppercase font-medium' href="/services/mobile-app-development"> Services </a>
            <a className='bg-[#7000FF] py-3 px-8 text-white rounded-sm font-medium' href="/contact-us"> Contact us </a> 
        </article>
    </div>
  )
}
