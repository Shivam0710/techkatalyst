...
export const FaqSection = ({ faq }: { faq: FAQ[] }) => {
  return (
    <div className='standard-margin-top px-6 lg:px-[100px] text-center'>
        <h3 className='text-[#101828] text-xl lg:text-5xl font-semibold'>
            Frequently asked questions
        </h3>
        <p className='text-sm lg:text-base text-[#212121] pt-4'>
            Everything you need to know about the product and billing.
        </p>
        <div className='pt-0 lg:pt-[60px] w-full lg:w-9/12 mx-auto'>
            {faq.map((item) => (
